 ...
 *
 * @see org.gradle.process.JavaForkOptions.setSystemProperties
 */
inline fun org.gradle.process.JavaForkOptions.`setSystemProperties`(vararg `properties`: Pair<String, Any>): Unit =
    `setSystemProperties`(mapOf(*`properties`))
