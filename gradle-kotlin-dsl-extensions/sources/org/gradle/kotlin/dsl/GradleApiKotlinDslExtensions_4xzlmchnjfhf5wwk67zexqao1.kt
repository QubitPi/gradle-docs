 ...
 * @since 8.7
 */
inline fun <T : org.gradle.api.services.BuildService<P>, P : org.gradle.api.services.BuildServiceParameters> org.gradle.api.services.BuildServiceRegistry.`registerIfAbsent`(`name`: String, `implementationType`: kotlin.reflect.KClass<T>): org.gradle.api.provider.Provider<T> =
    `registerIfAbsent`(`name`, `implementationType`.java)
