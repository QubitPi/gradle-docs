:samples-dir: /home/runner/work/gradle/gradle/platforms/documentation/docs/build/working/samples/install/building-java-applications-multi-project
...
====
include::sample[dir="kotlin",files="buildSrc/src/main/kotlin/buildlogic.java-common-conventions.gradle.kts[]"]
include::sample[dir="groovy",files="buildSrc/src/main/groovy/buildlogic.java-common-conventions.gradle[]"]
====
...
====
include::sample[dir="kotlin",files="buildSrc/src/main/kotlin/buildlogic.java-library-conventions.gradle.kts[]"]
include::sample[dir="groovy",files="buildSrc/src/main/groovy/buildlogic.java-library-conventions.gradle[]"]
====
====
include::sample[dir="kotlin",files="buildSrc/src/main/kotlin/buildlogic.java-application-conventions.gradle.kts[]"]
include::sample[dir="groovy",files="buildSrc/src/main/groovy/buildlogic.java-application-conventions.gradle[]"]
====
