...
When prompted, select the `2: library` project type and `4: Scala` as the implementation language.
...
<8> This dependency is exported to consumers, that is to say found on their compile classpath.
