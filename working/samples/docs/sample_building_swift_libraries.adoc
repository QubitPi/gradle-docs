:samples-dir: /home/runner/work/gradle/gradle/platforms/documentation/docs/build/working/samples/install/building-swift-libraries
:gradle-version: 9.0.0-milestone-10

= Building Swift Libraries Sample

[.download]
- link:zips/sample_building_swift_libraries-groovy-dsl.zip[icon:download[] Groovy DSL]
- link:zips/sample_building_swift_libraries-kotlin-dsl.zip[icon:download[] Kotlin DSL]
