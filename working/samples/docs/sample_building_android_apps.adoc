:samples-dir: /home/runner/work/gradle/gradle/platforms/documentation/docs/build/working/samples/install/building-android-apps
:gradle-version: 9.0.0-rc-2

= Building Android Apps Sample

[.download]
- link:zips/sample_building_android_apps-groovy-dsl.zip[icon:download[] Groovy DSL]
- link:zips/sample_building_android_apps-kotlin-dsl.zip[icon:download[] Kotlin DSL]
