:samples-dir: /home/runner/work/gradle/gradle/platforms/documentation/docs/build/working/samples/install/building-groovy-libraries
:gradle-version: 9.0.0-rc-2

= Building Groovy Libraries Sample

[.download]
- link:zips/sample_building_groovy_libraries-groovy-dsl.zip[icon:download[] Groovy DSL]
- link:zips/sample_building_groovy_libraries-kotlin-dsl.zip[icon:download[] Kotlin DSL]
...
When prompted, select the `2: library` project type and `3: Groovy` as the implementation language.
